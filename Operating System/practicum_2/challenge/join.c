/*
#
Buatlah program join.c
Tambahkan kode pada bagian // TODO
di fungsi main agar program utama selalu menunggu Thread 1 dan Thread 2
menyelesaikan eksekusi fungsi print_message_function mereka
#
*/
